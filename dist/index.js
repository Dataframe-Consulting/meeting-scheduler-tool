 ...
 */
const meetingSchedulerTool = (0, tools_1.createTool)({
    /**
    ...
    schema: {
        ...
        input: {
            ...
            description: (0, tools_1.stringField)({
                required: false,
                description: 'Optional meeting description',
                maxLength: 1000,
            }),
            allowCamera: (0, tools_1.booleanField)({
                required: false,
                description: 'Whether to allow attendees to enable camera',
                default: true,
            }),
            allowMicrophone: (0, tools_1.booleanField)({
                required: false,
                description: 'Whether to allow attendees to enable microphone',
                default: true,
            }),
            allowRecording: (0, tools_1.booleanField)({
                required: false,
         ...
         */
        config: {
            client_id: (0, tools_1.apiKeyField)({
                required: true,
                description: 'Microsoft Graph API client ID for authentication',
            }),
            client_secret: (0, tools_1.apiKeyField)({
                required: true,
    ...
    async execute(input, config, context) {
        ...
        try {
            ...
            const graphClient = new MicrosoftGraphClient(config.client_id, config.client_secret, config.tenant_id);
 ...
 */
exports.default = meetingSchedulerTool;
